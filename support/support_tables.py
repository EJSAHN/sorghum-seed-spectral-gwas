...
# -*- coding: utf-8 -*-
"""
Additional downstream summary tables for the Senegal sorghum spectral manuscript.

This script is the non-figure companion for downstream summary analyses.
It recursively discovers project assets, runs downstream summary analyses,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate downstream summary tables for the Senegal sorghum spectral manuscript.")
    parser.add_argument("--project-root", type=Path, default=Path("."), help="Root of the Senegal project folder.")
    parser.add_argument("--output-dir", type=Path, default=Path("analysis_outputs") / "tables", help="Directory for CSV/XLSX outputs.")
    ...
    parser.add_argument("--qtl-window-bp", type=int, default=250_000, help="Window used for QTL grouping.")
...
def main() -> int:
    ...
    log("[7/8] Inter-seed and heterogeneity summaries", args.verbose)
    ...
    sheet_dict = {
        "analysis_overview": analysis_coverage_table(),
        "sources": sources_df,
    ...
    workbook_path = output_dir / "senegal_analysis_support_tables.xlsx"
