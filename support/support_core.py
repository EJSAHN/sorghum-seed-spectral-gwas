...
# -*- coding: utf-8 -*-
"""
Shared utilities for downstream summary analyses of the Senegal sorghum spectral dataset.
...
- Produces tables that summarize manuscript-level analyses and downstream outputs.
"""
...
def write_workbook(path: Path, sheet_dict: Dict[str, pd.DataFrame]) -> None:
    """Write an Excel workbook using xlsxwriter."""
